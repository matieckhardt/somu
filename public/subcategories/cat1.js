...
function consultarCategorias() {
    var urlCompleta = '/OperacionCategorias/ObtenerSubCategorias';
    ...
    response.forEach(element => {
        try {
            ...
            if (response.length < 5) {
                categoria.href = "/Home/Products?categoriaId=" + element.SubCategorias.SubCategoriaId;
                categoria.className = "w-50 h-50";
                categoria.innerHTML = "<div class='w-100 h-100 category-custom' style='background: url(/img/categories/cat" + element.SubCategorias.SubCategoriaId + ".jpg'></div><h1 class='text-white text-left pt-3'>" + element.SubCategorias.SubCategoriaName[0] + "</h1>";
